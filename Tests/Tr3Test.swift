...
public class Tr3Test {
    ...
    func testPassthrough() { print("\n━━━━━━━━━━━━━━━━━━━━━━ \(#function) ━━━━━━━━━━━━━━━━━━━━━━\n")
        ...
        if tr3Parse.parseScript(root, script),
            ...
            a.addCallback { val in self.addCallResult(a,val) }
            b.addCallback { val in self.addCallResult(b,val) }
            c.addCallback { val in self.addCallResult(c,val) }
    ...
    func testTernary1() { print("\n━━━━━━━━━━━━━━━━━━━━━━ \(#function) ━━━━━━━━━━━━━━━━━━━━━━\n")
        ...
        if tr3Parse.parseScript(root, script),
            ...
            w.addCallback { val in self.addCallResult(w,val) }
    ...
    func testTernary3() { print("\n━━━━━━━━━━━━━━━━━━━━━━ \(#function) ━━━━━━━━━━━━━━━━━━━━━━\n")
        ...
        if tr3Parse.parseScript(root, script),
            ...
            w.addCallback { val in self.addCallResult(w,val) }
            x.addCallback { val in self.addCallResult(x,val) }
            y.addCallback { val in self.addCallResult(y,val) }
