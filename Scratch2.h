    ...
    panel {
        _cell {
            ...
            controls {
                ...
                ruleOn {
                    type "panelon" title "Active" frame (x 202, y 4, w 40, h 32) icon "icon.ring.white.png" value (0..1) >>(controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) cell.speed.restart) lag (0) }
                version {
        ...
        cell {
            fader: _cell {
                ...
                controls {
                    hide {
                        type "panelx" title "hide" frame (x 0, y 0, w 40, h 40) icon "icon.thumb.X.png" value (0..1) }
                    ruleOn {
                        type "panelon" title "Active" frame (x 202, y 4, w 40, h 32) icon "icon.cell.fader.png" value (0..1) >>(controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) cell.speed.restart shader.cellFader.on) lag (0) }
                    version {
            ...
            zhabatinski: _cell {
                ...
                controls {
                    hide {
                        type "panelx" title "hide" frame (x 0, y 0, w 40, h 40) icon "icon.thumb.X.png" value (0..1) }
                    ruleOn {
                        type "panelon" title "Active" frame (x 202, y 4, w 40, h 32) icon "icon.cell.zhabatinski.png" value (0..1)
                        >> (controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) controls.ruleOn.value(0) cell.speed.restart shader.cellZhabatinski.on)
                        lag (0) }
                    version {
            ...
            scroll {
                ...
                controls {
                    scrollOn {
                        type "panelon" title "Active" frame (x 148, y 6, w 40, h 32) icon "icon.scroll.png" value (0..1) lag (0) user >>(controls.scrollBox.value(x 0.5, y 0.5) controls.brushTilt.value(0)) }
                    hide {
                        type "panelx" title "hide" frame (x 0, y 0, w 40, h 40) icon "icon.thumb.X.png" value (0..1) }
                    scrollBox {
                        type "box" title "Screen Scroll" frame (x 8, y 44, w 128, h 128) radius (10) tap2 (-1, -1) lag (0) value (x 0..1.5, y 0..1.5) <>sky.input.azimuth >>drawScroll.buffer.scroll user >>(controls.brushTilt.value(0) controls.scrollOn.value(1)) }
                    brushTilt {
        ...
        shader {
            ...
            tile {
                ...
                controls {
                    ...
                    repeatBox {
                        type "box" title "Repeat" frame (x 10, y 40, w 120, h 120) radius (10) tap2 (-1, -1) lag (0) user (0..1 = 1) >>controls.tileOn.value(1) value (0..1, 0..1) >>render.buffer.repeat }
                    mirrorBox {
                        type "box" title "Mirror" frame (x 140, y 60, w 80, h 80) radius (10) tap2 (1, 1) lag (0) user (0..1 = 1) value (0..1, 0..1) >>render.buffer.mirror }
                }
            }
        }
    }
